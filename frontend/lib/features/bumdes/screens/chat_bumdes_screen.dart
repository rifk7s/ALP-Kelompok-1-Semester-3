...
class ChatBumdesPage extends StatefulWidget {
  ...
  const ChatBumdesPage({super.key, required this.name, required this.image});

  @override
  State<ChatBumdesPage> createState() => _ChatBumdesPageState();
}

class _ChatBumdesPageState extends State<ChatBumdesPage> {
